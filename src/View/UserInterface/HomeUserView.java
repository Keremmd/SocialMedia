...
public class HomeUserView extends JPanel implements View
{
    ...
    private void MakeTabs()
    {
        ...
        tabbedPane.add("Sarch",userController.GetSearchView());
...
//TODO yapılacaklar şöyle arkadaş ekleme grup oluşturma mekanizması oluşturup sırayla userinterfacelerin içini doldurcan
// mantık gui yani viewde olay oldu butona basıldı controller çağrıldı controllerdaki metod observerlara haber ediyor ve
// modeldeki kayıt/değiştirme/get/set metodlarını çağrıyor ve database üzerinde işlem yapılıyor, sonuç da guiye yansıyor
// view-->controller-->model-->view sırasıyla