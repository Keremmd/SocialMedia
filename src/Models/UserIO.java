...
public class UserIO implements Model
{
    ...
    public void Log(String mail,String passwd,String id)
    {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(DIRECTORY,LOG_LIST),true));
            writer.write(mail);
    ...
    public int SignIn(String mail,String passwd)
    {
        try {
            BufferedReader reader = new BufferedReader(new FileReader(new File(DIRECTORY,USER_LIST)));
            String line = reader.readLine();
    ...
    public Vector<Vector<Object>> getLastLogged() // profili yazdırmak için bunu kullanıyorum
    {
    ...
    public Vector<Vector<Object>> getFriendsOfUser()
    {
    ...
    public Vector<Object> GetUserFromId(String id) // for add people
    {
        UserUtil util  =new UserUtil();
    ...
    public Vector<Vector<Object>> GetPostsOfLastLogged()
    {
    ...
    public Vector<Object> SavePost(String post)
    {
    ...
    public void UpdateFriends(String newFriendID)
    {
        ...
        try
        {
            ...
            for (int x=0; x<allUsers.length; x++) {
                ...
                if (currentFields[ID_FIELD].equals(id))
                {
                ...
                if (currentFields[ID_FIELD].equals(newFriendID)) {
                    StringBuilder str = new StringBuilder();
                    for (String friend : currentFields[FRIENDS_FIELD].split("-"))
                    {
                        if (friend.equals(" ")) continue;
    ...
    public ArrayList<String> GetUserAndUsernames()
    {
        ...
        try {
            ...
            while (line != null) {
                StringBuilder str = new StringBuilder();
                String[] fields = line.split(":");
                str.append(fields[USERNAME_FIELD]).append(",").append(fields[NAME_FIELD]);
